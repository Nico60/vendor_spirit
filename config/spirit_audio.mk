...
NOTIFICATION_PATH := vendor/spirit/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/spirit/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/spirit/prebuilt/common/media/audio/ui
